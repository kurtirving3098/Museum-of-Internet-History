<script setup>
  ...
  const handleSubmit = async () => {
    ...
    try {
      await globalStore.login({ email: email.value, password: password.value });
      
      // Check role directly from the store state after login completes
      ...
      <div class="row justify-content-center">
        <div class="col-12 col-sm-9 col-md-7 col-lg-5">
          ...
          <div class="text-center mb-5">
            <span class="small tracking-wider fw-bold lbl">WELCOME BACK</span>
            <h1 class="display-6 fw-normal mt-2 text-white sec-title">Log <em>In</em></h1>
          </div>
